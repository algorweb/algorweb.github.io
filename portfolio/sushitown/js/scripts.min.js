...
$(function(){$(".form-header").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"../mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1}),$(".form-order").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"../mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1});var e=document.querySelector('[data-ref~="mixitup-container"]');mixitup(e,{selectors:{target:'[data-ref~="mixitup-target"]'},animation:{duration:400,nudge:!1,reverseOut:!1,effects:"scale(0.17)"}});$(".menu-item a").mPageScroll2id({scrollSpeed:700})});